...
TOKEN = '7842982937:AAGfNhHbGOSV9LjBnWun_cH2BLqOgYOOxvw' #توكنك 
ADMIN_ID ='6652442220'  # ايديك
channel = '@DARK_0_X' #يوزر قناتك هنا مش الرابط
# @XS5_S
...
def send_welcome(message):
    ...
    dev_channel_button = types.InlineKeyboardButton('🔧 قناة المطور', url='https://t.me/DARK_0_X')
